...
def run(
    ...
    #LOGGER.info(type(save_dir))
    save_dir =Path("runs\server")
    # Load model
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    output_cls.append(names[int(cls)])
                    perclasses+=1
                    ...
                    if save_crop:
                        save_one_box(xyxy, imc, file=save_path / 'crops' / names[c] / f'{p.stem}.jpg', BGR=True)
